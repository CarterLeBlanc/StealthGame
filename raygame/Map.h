...
{
public:
	Map(Vector2 mapSize, Vector2 tileSize, T initialData, Color initialColor);
	~Map();
...
template <typename T>
inline Map<T>::Map(Vector2 mapSize, Vector2 tileSize, T initialData, Color initialColor)
{
	m_mapSize = mapSize;
	m_tileSize = tileSize;
...
template<typename T>
inline void Map<T>::createTile(Vector2 coordinates, T data, Color color)
{
	//Create the tile
...
template<typename T>
inline Tile<T> Map<T>::getTile(Vector2 coordinates)
{
...
template<typename T>
inline Tile<T> Map<T>::checkTile(Vector2 coordinates)
{
...
template<typename T>
inline void Map<T>::drawTile(Tile<T> tile, Vector2 coordinates)
{
